...
pitch(show=False)
#url = 'ASH VS LYON.csv'
balls_xy = pd.read_csv(r'C:\Users\ninad\Desktop\Cricket Data\ASH VS LYON.csv')
print(balls_xy)
plt.rcParams['figure.figsize'] = [2.5, 6]

ax = sns.scatterplot(balls_xy.iloc[:,0]+1.83,22.56 - balls_xy.iloc[:,1], hue = balls_xy.iloc[:,2],palette='hot')
